...
extern DELPHI_PACKAGE void __fastcall DrawWindowButton(Vcl::Graphics::TCanvas* Canvas, System::Types::TPoint Pos, int Size, TDrawWindowButtonType ButtonType);
extern DELPHI_PACKAGE void __fastcall DrawRadioButton(Vcl::Graphics::TCanvas* Canvas, System::Types::TPoint Pos, int Size, System::Uitypes::TColor clBackground, System::Uitypes::TColor clHotBkGnd, System::Uitypes::TColor clLeftOuter, System::Uitypes::TColor clRightOuter, System::Uitypes::TColor clLeftInner, System::Uitypes::TColor clRightInner, bool Checked, bool Enabled, bool Hot);
extern DELPHI_PACKAGE void __fastcall DrawCheckBox(Vcl::Graphics::TCanvas* Canvas, System::Types::TPoint Pos, int Size, System::Uitypes::TColor clBackground, System::Uitypes::TColor clHotBkGnd, System::Uitypes::TColor clLeftOuter, System::Uitypes::TColor clRightOuter, System::Uitypes::TColor clLeftInner, System::Uitypes::TColor clRightInner, bool Checked, bool Enabled, bool Hot);
...
extern DELPHI_PACKAGE void __fastcall AlphaBlend(HDC Source, HDC Destination, const System::Types::TRect &R, System::Types::TPoint Target, TCommonBlendMode Mode, int ConstantAlpha, int Bias);
...
extern DELPHI_PACKAGE bool __fastcall DragDetectPlus(HWND Handle, System::Types::TPoint Pt);
