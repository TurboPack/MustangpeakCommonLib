...
// (DO NOT EDIT: machine generated header) 'MPThreadManager.pas' rev: 31.00 (Windows)
...
public:
	...
	__property NativeUInt ID = {read=FID, write=FID};
...
_DECLARE_METACLASS(System::TMetaClass, TCommonThreadRequestClass);
...
protected:
	...
	__property NativeUInt Event = {read=GetEvent};
...
public:
	...
	__property HWND TargetWnd = {read=FTargetWnd, write=FTargetWnd};
	__property unsigned ThreadID = {read=FThreadID, nodefault};
};


_DECLARE_METACLASS(System::TMetaClass, TCommonBaseThreadClass);
...
_DECLARE_METACLASS(System::TMetaClass, TCommonEventThreadClass);
...
protected:
	...
	__property HWND FilterWindow = {read=GetFilterWindow, write=FFilterWindow};
...
static const NativeUInt TID_START = 0ULL;
