...
{
	virtual bool __fastcall AssignDragImage(Vcl::Graphics::TBitmap* Image, System::Types::TPoint HotSpot, System::Uitypes::TColor TransparentColor) = 0 ;
...
public:
	...
	bool __fastcall AssignDragImage(Vcl::Graphics::TBitmap* Image, System::Types::TPoint HotSpot, System::Uitypes::TColor TransparentColor);
...
_DECLARE_METACLASS(System::TMetaClass, TCommonDataObjectClass);
...
public:
	...
	__property NativeUInt HDropStruct = {read=GetHDropStruct};
	virtual bool __fastcall SaveToClipboard(void);
	virtual bool __fastcall SaveToDataObject(_di_IDataObject DataObject);
