...
public:
	...
	__property NativeUInt ButtonTheme = {read=FButtonTheme, write=FButtonTheme};
	__property NativeUInt ComboBoxTheme = {read=FComboBoxTheme, write=FComboBoxTheme};
	__property NativeUInt EditThemeTheme = {read=FEditTheme, write=FEditTheme};
	__property NativeUInt ExplorerBarTheme = {read=FExplorerBarTheme, write=FExplorerBarTheme};
	__property NativeUInt HeaderTheme = {read=FHeaderTheme, write=FHeaderTheme};
	__property NativeUInt ListviewTheme = {read=FListviewTheme, write=FListviewTheme};
	__property bool Loaded = {read=FLoaded, nodefault};
	__property Vcl::Controls::TWinControl* Owner = {read=FOwner};
	__property NativeUInt ProgressTheme = {read=FProgressTheme, write=FProgressTheme};
	__property NativeUInt RebarTheme = {read=FRebarTheme, write=FRebarTheme};
	__property NativeUInt ScrollbarTheme = {read=FScrollbarTheme, write=FScrollbarTheme};
	__property NativeUInt TaskBandTheme = {read=FTaskBandTheme, write=FTaskBandTheme};
	__property NativeUInt TaskBarTheme = {read=FTaskBarTheme, write=FTaskBarTheme};
	__property NativeUInt TreeviewTheme = {read=FTreeviewTheme, write=FTreeviewTheme};
	__property NativeUInt WindowTheme = {read=FWindowTheme, write=FWindowTheme};
};


typedef void __fastcall (__closure *TCommonMouseEnterEvent)(System::TObject* Sender, System::Types::TPoint MousePos);
...
protected:
	...
	virtual void __fastcall DoMouseEnter(System::Types::TPoint MousePos);
	virtual void __fastcall DoMouseExit(void);
	virtual void __fastcall DoMouseTrack(System::Types::TPoint MousePos);
